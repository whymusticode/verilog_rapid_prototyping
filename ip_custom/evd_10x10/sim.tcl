...
exec /opt/Xilinx/Vivado/2024.1/bin/xvlog -sv $proj_dir/rtl/uart_rx.v \
                                           ...
                                           $proj_dir/sim/tb_jacobi_engine.v

exec /opt/Xilinx/Vivado/2024.1/bin/xelab tb_jacobi_engine -s tb_jacobi_engine_sim -debug typical
exec /opt/Xilinx/Vivado/2024.1/bin/xsim tb_jacobi_engine_sim -runall
quit
