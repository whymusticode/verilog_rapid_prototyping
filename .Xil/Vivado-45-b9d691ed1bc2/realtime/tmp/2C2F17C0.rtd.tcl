...
set genomeRtd $env(RT_TMP)/2C2F17C0.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {jacobi_sweep10x10__GB4}]"
...
set genomeName [subst -nocommands -novariables {jacobi_sweep10x10__GB4}]
