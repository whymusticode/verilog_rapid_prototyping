namespace eval ::optrace {
  variable script "/workspace/demo/cordic_demo/cordic_demo.runs/impl_1/top.tcl"
...
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir /workspace/demo/cordic_demo/cordic_demo.cache/wt [current_project]
  set_property parent.project_path /workspace/demo/cordic_demo/cordic_demo.xpr [current_project]
  set_property ip_output_repo /workspace/demo/cordic_demo/cordic_demo.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet /workspace/demo/cordic_demo/cordic_demo.runs/synth_1/top.dcp
OPTRACE "read constraints: implementation" START { }
  read_xdc /workspace/demo/Basys3.xdc
