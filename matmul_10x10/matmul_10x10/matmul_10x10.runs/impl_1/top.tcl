namespace eval ::optrace {
  variable script "/workspace/matmul_10x10/matmul_10x10/matmul_10x10.runs/impl_1/top.tcl"
...
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir /workspace/matmul_10x10/matmul_10x10/matmul_10x10.cache/wt [current_project]
  set_property parent.project_path /workspace/matmul_10x10/matmul_10x10/matmul_10x10.xpr [current_project]
  set_property ip_output_repo /workspace/matmul_10x10/matmul_10x10/matmul_10x10.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet /workspace/matmul_10x10/matmul_10x10/matmul_10x10.runs/synth_1/top.dcp
OPTRACE "read constraints: implementation" START { }
  read_xdc /workspace/matmul_10x10/Basys3.xdc
